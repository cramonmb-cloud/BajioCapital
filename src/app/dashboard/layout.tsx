...
export default function DashboardLayout({
  ...
  return (
    <div className="flex min-h-screen w-full flex-col bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-primary/5 via-background to-background">
      ...
      <main className="flex flex-1 flex-col gap-4 p-4 md:gap-6 md:p-8 max-w-[1600px] mx-auto w-full animate-in fade-in slide-in-from-bottom-2 duration-500 ease-out">
        {children}
      </main>
    </div>
  );
